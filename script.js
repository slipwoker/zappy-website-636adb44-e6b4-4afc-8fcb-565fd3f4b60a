document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function getErrorMessage(rule, value) {
      if (rule === 'minlength') {
        return ERROR_MESSAGES.minlength(value);
      }
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      // Simulate async submission — replace with actual fetch/XHR
      setTimeout(function () {
        contactForm.reset();

        // Remove success classes after reset
        contactForm.querySelectorAll('.field-success').forEach(function (field) {
          field.classList.remove('field-success');
        });
  ...
  if ('IntersectionObserver' in window) {
    ...
    // Also auto-observe common marketing sections if no fade-in class present
    ...
    AUTO_SELECTORS.forEach(function (selector) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מורגן משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '636adb44-e6b4-4afc-8fcb-565fd3f4b60a',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '636adb44-e6b4-4afc-8fcb-565fd3f4b60a';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '636adb44-e6b4-4afc-8fcb-565fd3f4b60a';
